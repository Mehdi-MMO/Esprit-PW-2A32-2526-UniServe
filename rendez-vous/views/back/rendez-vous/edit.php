...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        nav { background: #fff; padding: 15px 40px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 2px 5px rgba(0,0,0,.08); position: sticky; top: 0; }
        ...
        .nav-links a.active { color: #26a69a; }
        ...
        <div class="form-card">
            <form method="POST" action="index.php?page=back&action=store">
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" name="titre" id="titre" placeholder="Ex: Professor Meeting">
                </div>
                <div class="form-group">
                    <label>Date</label>
