...
('Admin',    'UniServe', 'admin@uniserve.net',    'uniserveadmin', 'admin'),
('Dupont',   'Jean',     'etudiant@uniserve.net', 'etudiant123',   'etudiant'),
('Martin',   'Sophie',   'staff@uniserve.net',    'staff123',      'staff'),
('Leclerc',  'Paul',     'prof@uniserve.net',     'prof123',       'enseignant');
