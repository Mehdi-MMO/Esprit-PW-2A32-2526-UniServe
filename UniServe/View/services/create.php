<div class="row justify-content-center">
    <div class="col-md-8 col-lg-6">
        <div class="d-flex justify-content-between align-items-center mb-4 mt-2">
            <h1 class="h3 mb-0 text-gray-800">Nouveau Service</h1>
        ...
        <div class="card shadow-sm border-0 rounded-3">
            <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                <h5 class="card-title text-primary mb-0"><i class="bi bi-info-circle me-2"></i>Informations du service</h5>
                <p class="text-muted small mt-1">Remplissez les détails ci-dessous pour ajouter un nouveau service.</p>
            </div>
            <div class="card-body p-4">
                <form action="<?= $this->url('/services/store') ?>" method="POST" id="formService" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" class="form-control border-start-0 ps-0" id="nom" name="nom" placeholder="Ex: Certificat de scolarité" required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <textarea class="form-control border-start-0 ps-0" id="description" name="description" rows="4" placeholder="Décrivez le but de ce service..." required></textarea>
                    ...
                    <div class="mb-4 p-3 bg-light rounded-3 d-flex justify-content-between align-items-center border">
                        ...
                        <div class="form-check form-switch fs-4 mb-0">
                            <input class="form-check-input" type="checkbox" role="switch" id="actif" name="actif" checked style="cursor: pointer;">
                        </div>
                    </div>
