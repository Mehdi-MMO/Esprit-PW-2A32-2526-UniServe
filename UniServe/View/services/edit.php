                ...
                <form action="<?= $this->url('/services/update/' . $service['id']) ?>" method="POST" id="formService" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" class="form-control border-start-0 ps-0" id="nom" name="nom" value="<?= htmlspecialchars($service['nom']) ?>" required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <textarea class="form-control border-start-0 ps-0" id="description" name="description" rows="4" required><?= htmlspecialchars($service['description']) ?></textarea>
                    ...
                    <div class="mb-4 p-3 bg-light rounded-3 d-flex justify-content-between align-items-center border">
                        ...
                        <div class="form-check form-switch fs-4 mb-0">
                            <input class="form-check-input" type="checkbox" role="switch" id="actif" name="actif" <?= $service['actif'] ? 'checked' : '' ?> style="cursor: pointer;">
                        </div>
                    </div>
