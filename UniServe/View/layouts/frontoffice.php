        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="frontNav">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="<?= $this->url('/utilisateurs') ?>">Utilisateurs</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?= $this->url('/demandes/frontoffice') ?>">Demandes</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= $this->url('/evenements') ?>">Evenements</a></li>
                </ul>
                <div class="dropdown">
