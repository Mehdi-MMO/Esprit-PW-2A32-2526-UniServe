...
<body>
    <aside class="sidebar d-flex flex-column">
        ...
        <nav class="nav flex-column p-3 gap-1">
            ...
            <a class="nav-link" href="<?= $this->url('/demandes/backoffice') ?>"><i class="bi bi-journal-text me-2"></i>Demandes de service</a>
            <a class="nav-link" href="<?= $this->url('/rendezvous') ?>"><i class="bi bi-calendar-check me-2"></i>Rendez-vous</a>
            <a class="nav-link" href="<?= $this->url('/documents') ?>"><i class="bi bi-file-earmark-text me-2"></i>Documents académiques</a>
