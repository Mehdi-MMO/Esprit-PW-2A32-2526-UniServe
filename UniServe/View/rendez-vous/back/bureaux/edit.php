<div class="row justify-content-center">
    <div class="col-lg-7 col-xl-6">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                <h1 class="h4 fw-bold mb-0" style="color:var(--brand)">
                    <i class="bi bi-pencil-square me-2"></i>Modifier le Bureau
                </h1>
        ...
        <div class="us-card p-4">
            <form action="index.php?page=back&module=offices&action=update"
                  method="POST"
                  onsubmit="return validateBureauForm()">

                <input type="hidden" name="id"
                       value="<?= htmlspecialchars((string)($bureau['id'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
