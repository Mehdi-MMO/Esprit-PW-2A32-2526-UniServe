            ...
            <div class="card-body p-4">
                <form action="<?= $this->url('/demandes/update/' . $demande['id']) ?>" method="POST" id="formDemande" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="hidden" name="service_id" value="<?= $demande['service_id'] ?>">
                        <div class="input-group">
                            ...
                            <div class="form-control border-start-0 border-secondary bg-secondary bg-opacity-10 text-muted d-flex align-items-center" style="pointer-events:none;">
                                <?= htmlspecialchars($demande['service_nom']) ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="email" class="form-control border-start-0 ps-0" id="email" name="email" value="<?= htmlspecialchars($demande['email'] ?? '') ?>" placeholder="votre.email@exemple.com" required>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="tel" class="form-control border-start-0 ps-0" id="telephone" name="telephone" value="<?= htmlspecialchars($demande['telephone'] ?? '') ?>" placeholder="Ex: 12345678" maxlength="8" pattern="[0-9]{8}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" class="form-control border-start-0 ps-0" id="titre" name="titre" value="<?= htmlspecialchars($demande['titre']) ?>" required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <textarea class="form-control border-start-0 ps-0" id="description" name="description" rows="6" required><?= htmlspecialchars($demande['description']) ?></textarea>
