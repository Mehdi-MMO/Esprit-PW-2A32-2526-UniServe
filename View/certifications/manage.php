    ...
    <div class="card-header bg-white py-3">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <div class="d-flex flex-wrap gap-2 align-items-center">
                ...
                <button class="btn btn-sm btn-outline-danger" onclick="exportTablePDF('demandesTable','Demandes de Certification',['#','Certificat','Cours','Organisme','Date souhaitée','Soumis le','Statut'])">
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0" id="demandesTable">
            <thead class="table-light">
                <tr>
                    <th style="cursor:pointer;" onclick="sortTableBy('demandesTable',0,this)"># <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th style="cursor:pointer;" onclick="sortTableBy('demandesTable',1,this)">Certificat souhaité <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th style="cursor:pointer;" onclick="sortTableBy('demandesTable',2,this)">Cours lié <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th style="cursor:pointer;" onclick="sortTableBy('demandesTable',3,this)">Organisme <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th style="cursor:pointer;" onclick="sortTableBy('demandesTable',4,this)">Date souhaitée <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th>Justificatif</th>
                    <th style="cursor:pointer;" onclick="sortTableBy('demandesTable',6,this)">Soumis le <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th>Statut</th>
                    <th>Quiz</th>
                    <th>Actions</th>
                </tr>
                ...
                <tr class="demande-row" data-statut="<?= htmlspecialchars($d['statut']) ?>">
                    ...
                    <td>
                        <?php if (!empty($d['fichier_path'])): ?>
                            <a href="/INTEG/public/uploads/certificats/<?= htmlspecialchars($d['fichier_path']) ?>"
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-white py-3">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <div class="d-flex gap-2 align-items-center flex-wrap">
                ...
                <button class="btn btn-sm btn-outline-danger" onclick="exportTablePDF('coursTableBO','Cours',['#','Titre','Formateur'])">
                    <i class="bi bi-file-earmark-pdf me-1"></i>PDF
                </button>
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0" id="coursTableBO">
            <thead class="table-light">
                <tr>
                    <th class="ps-4" style="cursor:pointer;" onclick="sortTableBy('coursTableBO',0,this)"># <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th style="cursor:pointer;" onclick="sortTableBy('coursTableBO',1,this)">Titre <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th style="cursor:pointer;" onclick="sortTableBy('coursTableBO',2,this)">Formateur <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="d-flex gap-1 justify-content-center">
                            ...
                            <form action="/INTEG/certifications/deleteCours" method="POST"
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-white py-3">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h5 class="mb-0"><i class="bi bi-patch-check me-2 text-success"></i>Liste des Certificats
                <span class="badge bg-success ms-2"><?= count($certificats) ?></span>
            </h5>
            <div class="d-flex gap-2 align-items-center flex-wrap">
                <div class="input-group input-group-sm" style="max-width:200px;">
                    <span class="input-group-text bg-white"><i class="bi bi-search text-muted"></i></span>
                    <input type="text" class="form-control border-start-0" placeholder="Rechercher…"
                           oninput="searchTable('certificatsTableBO', this.value)">
                </div>
                <button class="btn btn-sm btn-outline-danger" onclick="exportTablePDF('certificatsTableBO','Certificats',['#','Nom','Cours lié','Organisation','Date obtention'])">
                    <i class="bi bi-file-earmark-pdf me-1"></i>PDF
                </button>
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0" id="certificatsTableBO">
            <thead class="table-light">
                <tr>
                    <th style="cursor:pointer;" onclick="sortTableBy('certificatsTableBO',0,this)"># <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th style="cursor:pointer;" onclick="sortTableBy('certificatsTableBO',1,this)">Nom du certificat <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th style="cursor:pointer;" onclick="sortTableBy('certificatsTableBO',2,this)">Cours lié <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th style="cursor:pointer;" onclick="sortTableBy('certificatsTableBO',3,this)">Organisation <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th style="cursor:pointer;" onclick="sortTableBy('certificatsTableBO',4,this)">Date d'obtention <i class="bi bi-arrow-down-up small text-muted sort-icon"></i></th>
                    <th>Fichier</th><th>Actions</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($cert['fichier_path'])): ?>
                            <a href="/INTEG/public/uploads/certificats/<?= htmlspecialchars($cert['fichier_path']) ?>"
                               target="_blank" class="btn btn-outline-info btn-sm">
                                <i class="bi bi-file-earmark-text"></i> Voir
                            </a>
                        <?php else: ?><span class="text-muted">—</span><?php endif; ?>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            ...
                            <form action="/INTEG/certifications/deleteCertificat" method="POST"
...
<div class="modal fade" id="envoyerQuizModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form action="/INTEG/certifications/envoyerQuiz" method="POST" class="modal-content"
...
<div class="modal fade" id="addCoursModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <form action="/INTEG/certifications/storeCours" method="POST"
...
<div class="modal fade" id="editCoursModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <form action="/INTEG/certifications/editCours" method="POST"
              enctype="multipart/form-data" class="modal-content">
...
<div class="modal fade" id="addCertifModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="/INTEG/certifications/storeCertificat" method="POST" enctype="multipart/form-data" class="modal-content">
...
<div class="modal fade" id="editCertifModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="/INTEG/certifications/editCertificat" method="POST" enctype="multipart/form-data" class="modal-content">
            <div class="modal-header bg-warning">
    ...
    if (data.image_path) {
        imgBox.innerHTML = `
            <div class="d-flex align-items-center gap-2 mb-1">
                <img src="/INTEG/public/uploads/cours/${data.image_path}"
...
function openDecisionModal(id, action, nomCertificat) {
    ...
    if (action === 'accepter') {
        form.action = '/INTEG/certifications/accepterDemande';
        ...
        form.action = '/INTEG/certifications/refuserDemande';
...
function openCoursDetailBO(cours) {
    ...
    if (cours.image_path) {
        ...
        imgBox.innerHTML = `<img src="/INTEG/public/uploads/cours/${cours.image_path}"
    ...
    if (fichiers.length > 0) {
        ...
        filesBox.innerHTML = fichiers.map(f => {
            ...
            return `<a href="/INTEG/public/uploads/cours/${f.path}" target="_blank"
...
// ── Recherche universelle (colonnes de données seulement, sans Actions/Fichier) ──
const _searchCols = {
    'demandesTable':     [1, 2, 3, 4, 6],
    'coursTableBO':      [1, 2],
    'certificatsTableBO':[1, 2, 3, 4],
};
function searchTable(tableId, query) {
    const q    = query.toLowerCase().trim();
    const cols = _searchCols[tableId] || null;
    const tbody = document.querySelector('#' + tableId + ' tbody');
    if (!tbody) return;
    tbody.querySelectorAll('tr').forEach(row => {
        let text = '';
        if (cols) {
            cols.forEach(i => { if (row.cells[i]) text += row.cells[i].textContent + ' '; });
        } else {
...
// ── Tri universel ──────────────────────────────────────────────────
const _sortState = {};
function sortTableBy(tableId, colIndex, thEl) {
    const key = tableId + '_' + colIndex;
    const asc = !_sortState[key];
    _sortState[key] = asc;

    // Reset icônes du tableau
    document.querySelectorAll('#' + tableId + ' thead th i.sort-icon').forEach(i => {
        i.className = 'bi bi-arrow-down-up small text-muted sort-icon';
    });
    if (thEl) {
        const icon = thEl.querySelector('i');
        if (icon) {
            icon.className = (asc ? 'bi bi-arrow-up small text-primary sort-icon'
                                  : 'bi bi-arrow-down small text-primary sort-icon');
        }
    }
    ...
    const invisible = allRows.filter(r => r.style.display === 'none');
    ...
    invisible.forEach(r => tbody.appendChild(r));
}

// ── Export PDF universel (jsPDF — téléchargement direct) ──────────
...
function exportTablePDF(tableId, titre, colonnes) {
    const tbody = document.querySelector('#' + tableId + ' tbody');
    if (!tbody) return;
    const rows = Array.from(tbody.querySelectorAll('tr')).filter(r => r.style.display !== 'none');
    const body = rows.map(row =>
        Array.from(row.cells).slice(0, colonnes.length).map(c => c.textContent.trim())
    );
    loadJsPDF(() => {
        ...
        doc.text(titre + ' - UniServe', 14, 16);
        doc.setFontSize(9);
        doc.setTextColor(148, 163, 184);
        doc.text('Exporte le ' + new Date().toLocaleDateString('fr-FR') + ' a ' + new Date().toLocaleTimeString('fr-FR'), 14, 22);
        doc.autoTable({
            head: [colonnes],
            body: body,
            startY: 27,
            ...
            bodyStyles: { textColor: [51, 65, 85], lineColor: [226, 232, 240], lineWidth: 0.2 },
            foot: [[{ content: rows.length + ' enregistrement(s)', colSpan: colonnes.length, styles: { textColor: [148,163,184], fontSize: 8, fillColor: [255,255,255] } }]],
            showFoot: 'lastPage',
            margin: { left: 14, right: 14 },
        });
        const safe = titre.replace(/ /g, '_').replace(/[^a-zA-Z0-9_]/g, '');
