            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="role" name="role" required>
                        ...
                        ?>
                        <option value="etudiant" <?= $role === 'etudiant' ? 'selected' : '' ?> <?= ($singleAdminIdExists && $isSingleAdminEditingLocal) ? 'disabled' : '' ?>>etudiant</option>
                ...
                <div class="col-md-6">
                    <label class="form-label text-muted small" for="statut_compte">Statut_compte *</label>
