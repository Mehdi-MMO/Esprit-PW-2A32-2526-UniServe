    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="us-card p-4 p-md-4">
                <h1 class="h4 mb-2">Vérification de connexion</h1>
                ...
                <form method="post" action="<?= $this->url('/auth/verifyLoginRisk/' . (string) ($requestToken ?? '')) ?>" id="riskOtpForm">
                ...
                <a href="<?= $this->url('/auth/login') ?>" class="btn btn-outline-secondary w-100 mt-3">Retour à la connexion</a>
            </div>
        </div>
    </div>
</section>
...
document.addEventListener('DOMContentLoaded', function () {
    var form = document.getElementById('riskOtpForm');
