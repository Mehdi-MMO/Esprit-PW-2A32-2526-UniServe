...
$rdv = $rdv ?? [];
$old = $old ?? [
    'bureau_id'  => $rdv['bureau_id'] ?? '',
    'motif'      => $rdv['motif'] ?? '',
    'date_debut' => isset($rdv['date_debut']) ? date('Y-m-d\TH:i', strtotime($rdv['date_debut'])) : '',
    'date_fin'   => isset($rdv['date_fin']) ? date('Y-m-d\TH:i', strtotime($rdv['date_fin'])) : '',
];
$error = $error ?? null;
...
<div class="book-wrap">
    ...
    <div class="book-header">
        ...
        <div>
            <div class="book-header-title">Modifier Rendez-vous</div>
            <div class="book-header-sub">Modifiez les informations de votre demande.</div>
        </div>
    </div>
    ...
    <div class="book-card">
        ...
        <div class="book-card-body">
            ...
            <form action="<?= $this->url('/rendezvous/update/' . ($rdv['id'] ?? '')) ?>" method="POST"
                ...
                <div class="book-actions">
                    <button type="submit" class="book-submit">
                        <i class="bi bi-send-fill"></i>Enregistrer les modifications
                    </button>
