...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 us-page-header">
    <div>
        <div class="us-kicker mb-1">Demande club</div>
        <h1 class="h3 mb-1"><?= htmlspecialchars((string) ($title ?? 'Demander un club'), ENT_QUOTES, 'UTF-8') ?></h1>
        <p class="text-muted mb-0">Soumettez votre club, il sera approuve ou rejete par l administration.</p>
    </div>
    <a class="btn btn-outline-secondary btn-sm" href="<?= $this->url('/evenements/clubs') ?>">Retour</a>
</div>
...
<div class="us-section-card">
    <div class="card-body p-3 p-md-4">
        ...
        <form method="post" action="<?= $this->url('/evenements/createClubRequest') ?>">
            <div class="row g-3">
                <div class="col-md-8">
                    <label class="form-label text-muted small" for="nom">Nom du club *</label>
