<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Administration des utilisateurs et suivi des modules (placeholder).</p>
    </div>
</div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex flex-column">
                ...
                <div class="text-muted small mb-3">Gestion des comptes (placeholder).</div>
                <a href="<?= $this->url('/utilisateurs') ?>" class="btn btn-outline-primary btn-sm mt-auto">Ouvrir</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex flex-column">
                ...
                <div class="text-muted small mb-3">Traitement des demandes de service (placeholder).</div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex flex-column">
                ...
                <div class="text-muted small mb-3">Planification et suivi (placeholder).</div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex flex-column">
                ...
                <div class="text-muted small mb-3">Validation et livraison (placeholder).</div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex flex-column">
                ...
                <div class="text-muted small mb-3">Organisation et inscriptions (placeholder).</div>
