                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <?php if (in_array($_SESSION['user']['role'], ['staff', 'admin'])): ?>
                            <td class="text-end">
                                <a href="<?= $this->url('/services/edit/' . $service->getId()) ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
                                <form action="<?= $this->url('/services/delete/' . $service->getId()) ?>" method="POST" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce service ?');">
