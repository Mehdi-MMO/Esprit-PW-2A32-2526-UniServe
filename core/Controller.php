...
class Controller
{
    ...
    {
        // Defensive: callers should usually use requireLogin() before this.
        if (!$this->isLoggedIn()) {
            $this->redirect('/auth/login');
        }
        ...
        if (!in_array($currentRole, $roles, true)) {
            // Redirect users to the correct dashboard depending on their role.
            if (in_array($currentRole, ['etudiant', 'enseignant'], true)) {
